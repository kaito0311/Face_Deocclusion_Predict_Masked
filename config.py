class cfg:
    ...
    pretrained_g = "all_experiments/pretrained_deocclu_training/second_experiment/ckpt/good_33k/ckpt_gen_lastest.pt"
    pretrained_d = "all_experiments/pretrained_deocclu_training/second_experiment/ckpt/good_33k/ckpt_dis_lastest.pt"
