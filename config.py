class cfg:
    ...
    pretrained_g = "all_experiments/pretrained_deocclu_training/firt_experiment/ckpt/55k_ckpt/ckpt_gen_lastest.pt"
    pretrained_d = "all_experiments/pretrained_deocclu_training/firt_experiment/ckpt/55k_ckpt/ckpt_dis_lastest.pt"
